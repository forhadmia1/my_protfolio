...
const HeroArea = () => {
    ...
    return (
        <section id='hero-section' className='container md:px-12 md:h-screen md:mt-[-100px] mt-5 flex items-center flex-col md:flex-row-reverse'>
            ...
            <div>
                ...
                <ul className='flex gap-8 md:flex-col text-3xl md:mr-28'>
                    <li><AiFillGithub /></li>
                    <li><ImLinkedin2 /></li>
