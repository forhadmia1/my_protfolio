    ...
    return (
        <div className='mt-16'>
            ...
            <div className='grid grid-cols-1 gap-10 md:gap-5 md:grid-cols-3 md:px-12 px-4 mt-16'>
                <div class="card bg-base-100 shadow-xl hover:bg-fuchsia-400 hover:bg-opacity-30 duration-300">
                    ...
                    <div class="card-body py-6">
                        <h2 class="card-title text-sky-500">React Developer</h2>
                ...
                <div class="card bg-base-100 shadow-xl hover:bg-fuchsia-400 hover:bg-opacity-30 duration-300">
                    ...
                    <div class="card-body py-6 ">
                        <h2 class="card-title text-pink-500">Web Devloper</h2>
                        <p>I work with certain design tools to create high-fidelity designs and prototypes. I design accessible and usable products which aid business growth.</p>
                    </div>
                ...
                <div class="card bg-base-100 shadow-xl hover:bg-fuchsia-400 hover:bg-opacity-30 duration-300">
                    ...
                    <div class="card-body py-6 ">
                        <h2 class="card-title text-violet-500">Front-end Developer</h2>
                        <p>I work with certain design tools to create high-fidelity designs and prototypes. I design accessible and usable products which aid business growth.</p>
                    </div>
